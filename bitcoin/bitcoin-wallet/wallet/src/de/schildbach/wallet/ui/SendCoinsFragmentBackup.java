 ...
 */
public final class SendCoinsFragmentBackup extends SherlockFragment
{
	...
	private static final Logger log = LoggerFactory.getLogger(SendCoinsFragmentBackup.class);
	...
	{
		@Override
		public void onConfidenceChanged(final Transaction tx, final ChangeReason reason)
		{
